...
-- CreateIndex
CREATE UNIQUE INDEX "Account_provider_proverAccountId_key" ON "Account"("provider", "proverAccountId");
...
-- AddForeignKey
ALTER TABLE "Round" ADD CONSTRAINT "Round_fightId_fkey" FOREIGN KEY ("fightId") REFERENCES "Fight"("id") ON DELETE CASCADE ON UPDATE CASCADE;
